CREATE OR REPLACE FUNCTION public.balance_at_portfolio_normal(principal numeric, prime_rate numeric, term integer, months_paid integer)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
DECLARE
    ...
    wt_prime NUMERIC := 0.20;
    wt_near  NUMERIC := 0.30;
    wt_sub   NUMERIC := 0.25;
...
BEGIN
    ...
    LOOP
        ...
        total_balance := total_balance + seg_balance;
    END LOOP;
